...
function criarWidget() {
  ...
  widget.innerHTML = `
    ...
    <div id="chat-box" style="
      ...
      <div style="background:#e63946; color:white; padding:14px 16px; font-weight:bold; font-size:15px;">
      ...
      <div style="padding:10px; background:white; display:flex; gap:8px; border-top:1px solid #eee;">
        ...
        <button onclick="enviarMensagem()" style="
          ...
          padding:8px 14px; cursor:pointer; font-size:16px;">➤</button>
      </div>
    </div>
  `;
